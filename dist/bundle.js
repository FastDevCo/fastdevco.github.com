...
/******/ 	__webpack_require__.p = "/Users/elnygren/Dev/hacking/react-intro/example_solution/dist";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _editable = __webpack_require__(161);
	...
	var TaskItem = _react2.default.createClass({
	  ...
	  */
	  ...
	  render: function render() {
	    ...
	    var ready = _react2.default.createElement('i', { className: taskClass + ' fa fa-check-circle-o' });
	    ...
	    */
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'task-main' },
	        _react2.default.createElement(_editable.Editable, { value: this.props.task, onSave: this.save })
	      ),
	      _react2.default.createElement(
	        'div',
	...
	var AddTaskInput = _react2.default.createClass({
	...
	var TodoList = function TodoList(props) {
	  ...
	  var filteredTasks = props.tasks.filter(props.filter).map(function (task) {
	    return(
	      /*
	      ...
	      */
	      _react2.default.createElement(TaskItem, {
	        key: task.id,
	        id: task.id,
	        task: task.task,
	        done: task.done })
	...
	var TodoApp = _react2.default.createClass({
	  ...
	  */
	  ...
	  render: function render() {
	    ...
	    var notReadyTasks = function notReadyTasks(task) {
	      return !task.done;
	    };

	    var readyTasks = function readyTasks(task) {
	      return task.done;
	    };
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'todo-app' },
	      _react2.default.createElement(AddTaskInput, null),
	      _react2.default.createElement(_todoheader.TodoProgressBar, { tasks: allTasks }),
	      _react2.default.createElement(TodoList, { tasks: allTasks, type: 'not-ready-tasks', filter: notReadyTasks }),
	      _react2.default.createElement(TodoList, { tasks: allTasks, type: 'ready-tasks', filter: readyTasks })
	    );
	  }
	});

	_reactDom2.default.render(_react2.default.createElement(TodoApp, null), // this is our root component
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Editable = exports.Editable = React.createClass({
	  ...
	  render: function render() {
	    var editor = React.createElement("input", {
